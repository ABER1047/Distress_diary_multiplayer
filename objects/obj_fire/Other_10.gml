...
buffer_write(command_buffer, buffer_u8, code_m.DATA.REFRESH);
...
buffer_write(command_buffer, buffer_string,string("activate")); //refreshable values name
buffer_write(command_buffer, buffer_string,floor(activate*100)); //refreshable values
